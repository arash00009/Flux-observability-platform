...
## Result
The whole stack is described in Git and built in nine ordered parts (see the guide below). At Cloudist it ran as staging and production Kustomize overlays on a shared base, and the architecture and design decisions are written up in my 63-page thesis.
